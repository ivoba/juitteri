$(document).ready(function() {
	...
	$.Juitter.start({
		...
		searchObject:"nature", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		dateFormat: "pretty", //set your Date Format: locale, pretty, normal(RFC 2822)
		...
		readMore: "@Twitter", // read more message to be show after the tweet content
